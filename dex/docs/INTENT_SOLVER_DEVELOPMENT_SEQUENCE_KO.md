...
- 10-13 감사기관 공개 실적 조사 저장소 완료: OpenZeppelin·ChainSecurity·Certora의 공식 도메인과 공개 Lending 보고서만 허용한 비교 bundle을 생성한다. 공개 근거 범위와 마케팅 주장 한계를 분리하고 담당자·일정·가격·범위 수락·독립 재검증·이해충돌은 미확인으로 고정한다. 서면 제안 전에는 가중점수·shortlist·선정을 만들 수 없으며 외부 연락·자료전송·권한부여는 수행하지 않는다.
