...
The current suite compiles **39 Solidity sources** and reports **95 passing tests**. Future commits may change that count; the CI result for the exact reviewed commit is authoritative.
