...
The current suite compiles **41 Solidity sources** and reports **144 passing tests**. Future commits may change that count; the CI result for the exact reviewed commit is authoritative.
