(function(){
  ...
  let walletProvider,provider,signer,account,router,quoteRouter,executionRouter,nativeRouter,splitOptimizer,autoRouter,gasCostOracle,wallets=[],boundWallets=new WeakSet(),side='in',timer,mode='buy',tokenIn=cfg.tokens[0],tokenOut=cfg.tokens[2],deploymentReady=false;
