(function(root){
  ...
  root.LQCChartHealth=Object.freeze({classify,chainSync,consensusHead,consensusHash,sourceHealth,sourceHealthSnapshot,restoreSourceHealth,rankCanonicalSources,consensusQuote,bindQuote,quoteBindingMatches,bindQuoteRequest,quoteRequestMatches});
