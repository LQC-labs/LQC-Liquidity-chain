...
it("accepts execution only from IntentHub",function(){assert.match(s,/modifier onlyHub/);assert.match(s,/function execute[^\{]+onlyHub nonReentrant/)});
...
it("guards the Hub-to-Router path against reentrancy",function(){assert.match(s,/modifier nonReentrant/);assert.match(s,/error Reentrancy/);});});
