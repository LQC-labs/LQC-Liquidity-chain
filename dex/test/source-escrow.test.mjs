...
it("guards all token-moving entry points against reentrancy",function(){assert.equal((s.match(/external[^\{]+nonReentrant/g)||[]).length,4);assert.match(s,/error Reentrancy/)});});
