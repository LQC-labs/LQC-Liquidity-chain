...
describe("Lending Stage-1 live preflight page",function(){
  ...
  it("pins the exact two-contract manifest and roles",function(){assert.match(js,new RegExp(manifest.manifestDigest));assert.match(js,/LQCOracleManager/);assert.match(js,/LQCInterestRateModel/);assert.match(js,/0x5235e26EE4D511aE8ba1FB1cff2619Fc1D90C02A/);assert.match(js,/0xDc8003a7046be67F257D294b2680C20988A6bC2B/);assert.match(js,/crypto\.subtle\.digest/)});
