...
describe("LQC Intent v1 Composite Lending supply",function(){
  ...
  beforeEach(async function(){
    ...
    tokenIn=await deploy("MockERC20","mocks/MockERC20",owner,"Input","IN");debt=await deploy("MockERC20","mocks/MockERC20",owner,"Debt","DEBT");collateral=await deploy("MockERC20","mocks/MockERC20",owner,"Collateral","COL");
