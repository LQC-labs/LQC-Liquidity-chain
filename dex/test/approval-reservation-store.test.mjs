...
class RacingStorage extends MemoryStorage{arm(value){this.remainingReads=2;this.racingValue=value}getItem(key){if(this.remainingReads){this.remainingReads--;if(this.remainingReads===0)this.values.set(key,this.racingValue)}return super.getItem(key)}}
