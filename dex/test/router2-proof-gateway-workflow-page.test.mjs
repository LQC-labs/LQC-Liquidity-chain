...
describe("Router 2.0 Proof Gateway workflow page",function(){
  ...
  it("archives a completed execution before starting a new trade cycle",function(){assert.match(js,/HISTORY_KEY="lqc-router2-proof-gateway-execution-history-chain97-v1"/);assert.match(js,/LQC_PROOF_GATEWAY_EXECUTION_ARCHIVE_V1/);assert.match(js,/archiveHash=ethers\.keccak256/);assert.match(js,/history\.push\(\{\.\.\.core,archiveHash\}\)/);assert.match(js,/history\.slice\(-MAX_HISTORY\)/);assert.match(html,/새 거래 주기 시작/);});
